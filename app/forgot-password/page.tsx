        ...
        <div className="bg-white border border-stone-200 rounded-2xl p-7 backdrop-blur">
          {sent ? (
            <div className="text-center flex flex-col gap-4">
              ...
              <h1 className="text-xl font-black text-slate-900" style={{ fontFamily: "Sora,sans-serif" }}>Email terkirim!</h1>
              ...
              <a href="/login" className="text-amber-700 hover:text-amber-800 text-sm font-semibold transition-colors">← Kembali ke Login</a>
            </div>
          ) : (
            <>
              <h1 className="text-xl font-black text-slate-900 mb-1" style={{ fontFamily: "Sora,sans-serif" }}>Lupa password?</h1>
              ...
              <p className="text-center text-xs text-slate-500 mt-5">
                Ingat password? <a href="/login" className="text-amber-700 hover:text-amber-800 font-semibold">Masuk</a>
              </p>
            </>
          )}
        </div>

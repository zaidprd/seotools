...
const FAQS = [
  ...
  },
  {
    ...
    a: "Untuk blog umum dan SEO konten, Gemini 2.5 Flash (gratis) atau GPT-4.1 Mini (2 💎) adalah sweet spot — kualitas bagus, hemat. Untuk konten premium, landing page, atau artikel kompetitif yang panjang, GPT-5.4 (5 💎) atau Claude Sonnet 4.6 (7 💎) sangat direkomendasikan.",
  },
  {

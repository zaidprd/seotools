      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="prose prose-invert prose-sm max-w-none space-y-8 leading-relaxed">
          ...
          <section>
            ...
            <p className="text-slate-400">Prompt dan artikel yang dihasilkan mungkin diproses oleh penyedia AI pihak ketiga (SumoPod sebagai proxy AI untuk teks &amp; SVG, serta Google Gemini untuk gambar raster). Lihat kebijakan privasi masing-masing penyedia untuk detail lebih lanjut.</p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 mt-2 space-y-2 text-slate-400">
              ...
              <li><strong className="text-white">SumoPod</strong> — proxy AI utama untuk generate teks artikel &amp; SVG (Gemini 2.5 Flash, GPT-5.4, Claude Haiku/Sonnet)</li>
              <li><strong className="text-white">Google (Gemini / Imagen)</strong> — untuk generate gambar AI raster</li>
